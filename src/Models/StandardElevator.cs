...
{
    public class StandardElevator(int id, int maxCapacity, int maxFloors, ElevatorType type, Building building) : ElevatorContoller(id, maxCapacity, maxFloors, type, building)
    {
        public override void DisplayStatus()
        {
            Console.WriteLine(
                $"{Id,-3} | Standard  | {ElevatorState,-10} | Floor {CurrentFloor,-3} | {Direction,-10} | Passengers: {CurrentLoad}/{MaxCapacity}");
        }
